...
function applyExtendedOwnedShell(
  ...
  // Linux renders the command bar inside the content renderer because its
  // CompatibilityShell owns no separate chrome view; other platforms keep the
  // separate ordered chrome window.
