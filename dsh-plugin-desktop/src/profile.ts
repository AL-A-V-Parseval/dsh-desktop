...
function pendingDesktopShellConfig(
  ...
  // This fork presents the extended and advanced shells on Linux too, so the
  // platform never drops the mode the wizard already persisted.
  return merged
}
...
export function prepareDesktopProfile(
  ...
  if (pendingSection !== undefined
    ...
    && pendingDesktopShellConfig(desktopShellConfig, pendingSection) !== undefined
