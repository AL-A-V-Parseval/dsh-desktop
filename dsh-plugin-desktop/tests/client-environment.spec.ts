...
describe('desktop client environment', () => {
  ...
  it('accepts the Electron-owned kebab query markers', () => {
    ...
    expect(parseDesktopClientEnvironment('?dsh-desktop-mode=compatibility&dsh-desktop-platform=linux&dsh-desktop-version=2.0.3&dsh-desktop-material=transparent'))
      .toEqual({ version: '2.0.3', mode: 'compatibility', platform: 'linux', material: 'transparent', micaSupported: false })
