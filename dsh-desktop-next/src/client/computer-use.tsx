...
export function ComputerUseSettings({ context, zh, compact = false }: { context: Context; zh: boolean; compact?: boolean }) {
  ...
  return <div className="dshNextComputerUse" data-next-computer-use>
    ...
    {!compact && <p role="status" className="dshDesktopSettingsHint">{status}</p>}
