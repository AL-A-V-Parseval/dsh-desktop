...
上游正式安装包支持 Windows x64 和 universal macOS（Intel 与 Apple Silicon）。本 fork 另外提供 Linux x64 的便携包与 `.deb` 安装包，见 [Releases](https://github.com/Jic2007/dsh-desktop/releases)。
