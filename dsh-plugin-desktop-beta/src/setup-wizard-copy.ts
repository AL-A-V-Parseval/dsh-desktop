...
export interface DesktopSetupWizardCopy {
  ...
  readonly materialTransparentLinuxBody: string
...
const COPY: Record<DesktopLocale, DesktopSetupWizardCopy> = {
  en: {
    ...
    materialTransparentLinuxBody: 'Show the desktop behind the window; your compositor decides whether it is blurred.',
    materialMica: 'Mica',
  ...
  zh: {
    ...
    materialTransparentLinuxBody: '透出窗口背后的桌面；是否模糊由系统合成器决定。',
    materialMica: 'Mica',
